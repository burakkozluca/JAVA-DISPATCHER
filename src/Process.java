...
public class Process {
    ...
    public void run(int arrivaltime) {
        ...
        while (process_time > 0) {
            saniye += 1;
            if(priority >= 1 && arrivaltime == saniye)
            {
                System.out.println("\033[34m"+ saniye + "sn proses askıda" + "       (id:" + id + "  öncelik:" + priority + 1 + "  kalan süre:" + process_time + "sn)" + "\033[0m");
